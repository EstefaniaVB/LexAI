...
<<<<<<< HEAD
from apps import data, model, model_construction # import your app modules here
=======
from apps import home, data, model, model_construction # import your app modules here
